...
This project is on object-oriented programming using classes and objects; attributes, methods, and properties as well as data abstraction, data encapsulation, and information hiding in Python.

## Tests

* [tests](./tests): Test files for the function prototypes in this project.
