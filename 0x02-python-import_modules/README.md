...
This project is creating, importing and using functions and modules in Python. This include the builtin function `dir()` and using command line arguments within Python programs.
...
* **8. ByteCode -> Python #3**
  * [102-magic_calculation.py](./102-magic_calculation.py): Python function matching exactly a bytecode provided.
