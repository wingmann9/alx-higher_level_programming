...
This project is about class inheritance, super- and sub-classes; definining classes with multiple base classes, and overiding inherited methods and attributes in Python.

## Tests

* [tests](./tests): Folder of test files to test function prototypes in this project, as well as the following .txt files:
    * [1-my_list.txt](./1-my_list.txt)
    * [7-base_geometry.txt](./7-base_geometry.txt)

## Function Prototypes

Function prototypes in this project:
