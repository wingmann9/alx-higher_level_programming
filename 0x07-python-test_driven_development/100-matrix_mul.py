...
def matrix_mul(m_a, m_b):
    ...
    if (isinstance(m_a, list) and all(isinstance(row, list) for row in m_a) and all(isinstance(ele, (int, float)) for row in m_a for ele in row)) and (isinstance(m_b, list) and all(isinstance(row, list) for row in m_b) and all(isinstance(ele, (int, float)) for row in m_b for ele in row)):
