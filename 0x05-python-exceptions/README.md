...
This directory is about  handling errors and exceptions in Python with `try` and `except`.

## Tests

* [tests](./tests): Folder of test files for testing out function prototypes.

## Function Prototypes

* Function prototypes in this directory:
